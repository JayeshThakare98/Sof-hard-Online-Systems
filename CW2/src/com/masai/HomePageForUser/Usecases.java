...
//		int x =    sc.readLine(); Integer.parseInt(sc.readLine().trim());
		...
		//   HOD Start -----------------------------------------------------
		    ...
		    public void assignComplainToEngineer() throws NumberFormatException, IOException, EngineerExecption {
...
//		    Engineer start ---------------------------------------------------------
			...
			public void getComplainAssigenToEngineer() throws NumberFormatException, IOException, ComplainException, EngineerExecption {
...
//			sign up 
		public  void EmployeeRegistration() throws NumberFormatException, IOException ,EmployeeException{
...
//			  sc.readLine(); Integer.parseInt(sc.readLine().trim());
		...
		public boolean EmployeeLogin() throws IOException ,EmployeeException{
		...
		public  void EmployeeUpdatePassword() throws IOException, EmployeeException {
		...
		public void CreateComplain() throws IOException, ComplainException {
			...
			ComplainBean complainBean = new ComplainBean(0, Ctype,Cstatus,  EmployeeId);
			...
			if(id>0) {
				System.out.println("\n ++++++++++++++++++++++++ \n");
				System.out.println("Your complain raised \n");
		...
		public void CheckStatusOfProblem() throws NumberFormatException, IOException, ComplainException {
		...
		public void AllComplianHistoryList() throws NumberFormatException, IOException, ComplainException, EmployeeException {
